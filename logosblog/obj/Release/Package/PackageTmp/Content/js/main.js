...
(function($) {
    ...
    * ------------------------------------------------------ */
    var clSearch = function() {
        ...
        searchField.attr({placeholder: 'Aranacak Kelime', autocomplete: 'off'});
    ...
    * ------------------------------------------------------ */
    var clAjaxChimp = function() {
        ...
        $.ajaxChimp.translations.es = {
            'submit': 'Kayediliyor...',
            0: '<i class="fa fa-check"></i> Makale bültenimize başarılı bir şekilde kaydedildiniz.',
            1: '<i class="fa fa-warning"></i> Geçerli bir e-mail adresi giriniz.',
            2: '<i class="fa fa-warning"></i> E-mail adresi geçersiz.',
            3: '<i class="fa fa-warning"></i> E-mail adresi geçersiz.',
            4: '<i class="fa fa-warning"></i> E-mail adresi geçersiz.',
            5: '<i class="fa fa-warning"></i> E-mail adresi geçersiz.'
        } 
